...
A domain capability: discipline Land Ecosystems inside the Biosphere sphere. Pillar means sphere: one of the five Earth science spheres; a capability is skills, knowledge signed by its stewards and deterministic checks, delivered as one plugin.
...
Vegetation structure and function, carbon stocks and fluxes, phenology
and disturbance across terrestrial ecosystems.

## Ownership

Owned by @open-science-pillars/biosphere-maintainers (`CODEOWNERS`); one person
...
here relies on: ORNL DAAC (field campaigns, biogeochemistry) and LP DAAC (vegetation indices, GEDI). None engaged yet.
